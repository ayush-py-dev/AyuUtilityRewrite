...
class Info(commands.Cog):
    ...
    @commands.slash_command(guild_ids=[GUILD_ID],description="""Shows info about member""")
    ...
    @commands.user_command(guild_ids=[GUILD_ID],description="""Shows info about user""")
    async def whois_(self,ctx,user:discord.Member):
        member=user
    ...
    @commands.slash_command(guild_ids=[GUILD_ID],description="""Shows info about server""")
    ...
    @commands.slash_command(guild_ids=[GUILD_ID],description="""Shows info about channel""")
    ...
    @commands.slash_command(name="joined",description="""Check the join rank""")
    ...
    @commands.slash_command(name="joinpos",description="""Check the join position of a user""")
    ...
    @commands.command(name="calc",description="""Calculate something""")
